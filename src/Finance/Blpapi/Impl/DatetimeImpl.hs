...
kBLPAPIDATETIMEYEARPART = 0x1
kBLPAPIDATETIMEMONTHPART :: Int8
kBLPAPIDATETIMEMONTHPART = 0x2
kBLPAPIDATETIMEDAYPART :: Int8
kBLPAPIDATETIMEDAYPART = 0x4
kBLPAPIDATETIMEOFFSETPART :: Int8
kBLPAPIDATETIMEOFFSETPART = 0x8
kBLPAPIDATETIMEHOURSPART :: Int8
kBLPAPIDATETIMEHOURSPART = 0x10
kBLPAPIDATETIMEMINUTESPART :: Int8
kBLPAPIDATETIMEMINUTESPART = 0x20
kBLPAPIDATETIMESECONDSPART :: Int8
kBLPAPIDATETIMESECONDSPART = 0x40

-- 0x80 is out of range (128) for Int8,
-- is this intentional?
kBLPAPIDATETIMEFRACSECONDSPART :: Int8
kBLPAPIDATETIMEFRACSECONDSPART = 0x80
